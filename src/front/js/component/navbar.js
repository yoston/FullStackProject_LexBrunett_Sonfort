          ...
          <ul className="nav">
            <li className="nav-item">
              <div className="dropdown">
                <button className="btn btn-success d-flex justify-content-around align-items-center" data-bs-toggle="dropdown" style={{minWidth: "145px", minHeight:"42px", borderRadius:"8px" ,backgroundColor:"#800080"}}>
